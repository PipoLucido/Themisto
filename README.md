...
```mermaid graph LR A(Themisto: *ingresa usuario y contraseña) -- datos ingresados --> B[Inicio de secion en app A] A -- datos ingresados --> C[Inicio de secion en app B] A --datos ingresados--> D[Inicio de secion en app C]
